...
class ResConfigSettings(models.TransientModel):
    ...
    sequence_complaint_code_id = fields.Many2one(
        string="Sequence for the codes",
        comodel_name="ir.sequence",
        config_parameter="cim_channel.sequence_complaint_code_id",
        help="Default values of the codes",
    )
    ...
    length_tracking_code = fields.Integer(
        ...
        default=10,
        required=True,
        config_parameter="cim_channel.length_tracking_code",
        help="Tracking code length to identify complainants " "(number of characters)",
    )
    ...
    acknowledgement_period = fields.Integer(
        ...
        default=7,
        required=True,
        config_parameter="cim_channel.acknowledgement_period",
        help="Acknowledgement period for the complaint admission " "(number of days)",
    )
    ...
    automatic_email_state = fields.Boolean(
        ...
        default=False,
        required=True,
        config_parameter="cim_channel.automatic_email_state",
        help="Send e-mail to complainant after change the state of the " "complaint",
    )
    ...
    automatic_email_validate_com = fields.Boolean(
        ...
        default=False,
        required=True,
        config_parameter="cim_channel.automatic_email_validate_com",
    ...
    automatic_email_complainant_com = fields.Boolean(
        ...
        default=False,
        required=True,
        config_parameter="cim_channel." "automatic_email_complainant_com",
    ...
    notice_period = fields.Integer(
        ...
        default=10,
        required=True,
        config_parameter="cim_channel.notice_period",
    ...
    deadline = fields.Integer(
        ...
        default=1,
        required=True,
        config_parameter="cim_channel.deadline",
    ...
    def _check_state_selected(self):
        for record in self:
            if (
                record.deadline
                and record.deadline_extended
                and record.deadline_extended < record.deadline
            ):
